...
SRI_hat = reshape(A1*reshape(permute(reshape(B1*C1,[N,S,M,K]),[3,1,2,4]),[M*N,S*K]),[Q,S,K]);
toc
%%
% figure(2)
% subplot(1,2,1)
...
% subplot(1,2,2)
% imagesc(SRI_hat(:,:,44)); title('Result of TTD - band 44')
%%
d1=4;d2=4;
err1 = cell2mat(compute_metrics(SRI,SRI_hat,d1,d2));
